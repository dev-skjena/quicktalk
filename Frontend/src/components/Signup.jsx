    ...
    <>
      <div className="flex h-screen w-full justify-center items-center">
        <form
          ...
          className="border border-red-600 px-6 py-3 rounded-md space-y-3 w-96"
        >
          <h1 className="text-2xl text-blue-600 font-bold">Messanger</h1>
          ...
          <div className="flex justify-center">
            <input
              type="submit"
              className="bg-blue-600 text-white w-full rounded-lg py-2 cursor-pointer"
              value="Signup"
            ></input>
          </div>
          <p>
